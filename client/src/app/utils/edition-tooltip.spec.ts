/**
 * Testing strategy — Edition tooltip utility
 *
 * Approach:
...
import { buildEditionTooltipText, buildEditionTooltipData } from './edition-tooltip';

describe('Edition tooltip utility', () => {
    describe('buildEditionTooltipText', () => {
        it('should return tooltip with tile name only', () => {
            const cells: CellType[][] = [[CellType.Empty]];
            const items: IItem[] = [];
            const errorCodes: ErrorCode[] = [];

            const result = buildEditionTooltipText({ cellType: CellType.Empty, item: null, rowIndex: 0, colIndex: 0 }, cells, items, errorCodes);
        ...
        it('should return tooltip with tile and object name', () => {
            ...
            const result = buildEditionTooltipText({ cellType: CellType.Empty, item, rowIndex: 0, colIndex: 0 }, cells, items, errorCodes);
        ...
        it('should return tooltip with tile, object, and error message for invalid door placement', () => {
            ...
            const result = buildEditionTooltipText({ cellType: CellType.ClosedDoor, item: null, rowIndex: 0, colIndex: 1 }, cells, items, errorCodes);
        ...
        it('should return tooltip with error message for inaccessible cells', () => {
            ...
            const result = buildEditionTooltipText({ cellType: CellType.Empty, item: null, rowIndex: 2, colIndex: 2 }, cells, items, errorCodes);
        ...
        it('should not return a grid tooltip error message for low terrain coverage', () => {
            ...
            const result = buildEditionTooltipText({ cellType: CellType.Empty, item: null, rowIndex: 0, colIndex: 2 }, cells, items, errorCodes);
        ...
        it('should return null when tooltip data is null', () => {
            ...
            const data = buildEditionTooltipData({ cellType: CellType.Empty, item: null, rowIndex: 0, colIndex: 0 }, cells, items, errorCodes);
    ...
    describe('buildEditionTooltipData', () => {
        it('should build data with tile name', () => {
            const cells: CellType[][] = [[CellType.Ice]];
            const items: IItem[] = [];
            const errorCodes: ErrorCode[] = [];

            const result = buildEditionTooltipData({ cellType: CellType.Ice, item: null, rowIndex: 0, colIndex: 0 }, cells, items, errorCodes);
        ...
        it('should build data with tile and object name', () => {
            ...
            const result = buildEditionTooltipData({ cellType: CellType.Water, item, rowIndex: 0, colIndex: 0 }, cells, items, errorCodes);
        ...
        it('should build data with error message for highlighted tile', () => {
            ...
            const result = buildEditionTooltipData({ cellType: CellType.ClosedDoor, item: null, rowIndex: 0, colIndex: 1 }, cells, items, errorCodes);
        ...
        it('should not build a grid error message for low terrain coverage', () => {
            ...
            const result = buildEditionTooltipData({ cellType: CellType.Empty, item: null, rowIndex: 0, colIndex: 2 }, cells, items, errorCodes);
        ...
        it('should ignore low terrain coverage in grid highlights', () => {
            ...
            const result = buildEditionTooltipData({ cellType: CellType.Empty, item: null, rowIndex: 1, colIndex: 0 }, cells, items, errorCodes);
        ...
        it('should not include error message when no error codes are present', () => {
            ...
            const result = buildEditionTooltipData({ cellType: CellType.ClosedDoor, item: null, rowIndex: 0, colIndex: 0 }, cells, items, errorCodes);
