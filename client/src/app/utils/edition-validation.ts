...
const BOARD_ERROR_CODES = new Set<ErrorCode>([
...
export function buildEditionValidationHighlightedTiles(
    cells: CellType[][],
    items: IItem[],
...
export function getEditionBoardErrorMessages(errorCodes: readonly ErrorCode[]): string[] {
