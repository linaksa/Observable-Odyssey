...
export class ChatService implements OnDestroy {
    ...
    connect() {
        ...
        const joinChatPayload: IJoinChatPayload = playerName === undefined ? { roomId: activeGameId } : { roomId: activeGameId, playerName };

        this.socketService.emit<IJoinChatPayload, IMessage[]>(Namespaces.Game, SocketEvent.JoinChat, joinChatPayload, (response) => {
