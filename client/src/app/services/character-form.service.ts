...
import {
  AVAILABLE_BONUS_TYPES, AVAILABLE_DICE_TYPES,
  BONUS_VALUE, BonusType, DiceSelectionType, PLAYER_NAME_PATTERN,
...
import {
  Avatar, DEFAULT_PLAYER_ATTACK_POINTS, DEFAULT_PLAYER_DEFENSE_POINTS,
  DEFAULT_PLAYER_LIFE_POINTS, DEFAULT_PLAYER_SPEED_POINTS, DiceType, PLAYER_NAME_MAX_LENGTH, PLAYER_NAME_MIN_LENGTH,
