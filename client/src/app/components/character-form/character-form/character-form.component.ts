  ...
  @Output() submitForm = new EventEmitter<CharacterFormData>();
    ...
    onFormSubmitted() {
        const data: CharacterFormData = {
            name: this.playerNameCtrl.value,
            avatar: this.avatars[this.avatarIndexCtrl.value!].avatar,
            initialHealth: this.avatars[this.avatarIndexCtrl.value!].character.initialHealth,
            attackBonusDiceType: this.avatars[this.avatarIndexCtrl.value!].character.attackBonusDiceType,
            defenseBonusDiceType: this.avatars[this.avatarIndexCtrl.value!].character.defenseBonusDiceType,
            rapidityPoints: this.avatars[this.avatarIndexCtrl.value!].character.rapidityPoints,
            attackPoints: this.avatars[this.avatarIndexCtrl.value!].character.attackPoints,
